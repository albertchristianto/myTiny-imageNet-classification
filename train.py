...
def run():
	...
	parser.add_argument('--train_txtPath', default='datalist/train.txt', type=str, metavar='DIR',
	...
	parser.add_argument('--checkpoint_dir', default='checkpoint/20191201-2257', type=str, metavar='DIR',
	...
	cnn_model = getModels(args.input_size,trunk=args.model_type, numClass = args.num_class, pretrained_choice=args.pretrained)
